...
var ExpandTitle = function (_React$Component) {
    _inherits(ExpandTitle, _React$Component);

    function ExpandTitle(props) {
        _classCallCheck(this, ExpandTitle);

        return _possibleConstructorReturn(this, (ExpandTitle.__proto__ || Object.getPrototypeOf(ExpandTitle)).call(this, props));
    }

    _createClass(ExpandTitle, [{
        key: 'render',
        value: function render() {
            ...
            var props = _objectWithoutProperties(_props, ['children', 'show']);
